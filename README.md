...
5. npm install --save-dev ts-node-dev @types/express @types/jsonwebtoken @types/bcryptjs @types/node rimraf prisma
6. npm install cors
7. npm install --save-dev @types/cors
8. docker-compose up -d
9. npx prisma migrate dev 
10. En packege.json agregar los siguientes scripts : "dev": "tsnd --respawn --clear src/server.ts",   "build": "rimraf ./dist && tsc",   "start": "node dist/server.js"
