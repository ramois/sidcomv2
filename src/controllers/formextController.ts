...
export const updateEstado = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        // Si el estado es "EMITIDO", generamos el siguiente número de formulario con el prefijo "E-"
        let updatedNroFormulario: string | null = null;
        if (estado === "EMITIDO") {
            // Generamos el siguiente número con el prefijo "E-" solo si el estado es EMITIDO
